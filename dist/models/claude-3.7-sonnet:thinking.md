# Anthropic: Claude 3.7 Sonnet (thinking) API Pricing & Analysis | LLMCosts.dev

> Source: [LLMCosts.dev](https://llmcosts.dev) — Updated 2026-05-03
> Route cheapest: [OpenRouter](https://openrouter.ai/?ref=llmcosts)

## Overview
Anthropic: Claude 3.7 Sonnet (thinking) is an AI model provided by Anthropic. We are currently updating our AI analysis for this model.
...
**Q: Who made Anthropic: Claude 3.7 Sonnet (thinking)?**
