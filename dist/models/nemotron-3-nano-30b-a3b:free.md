# NVIDIA: Nemotron 3 Nano 30B A3B (free) API Pricing & Analysis | LLMCosts.dev

> Source: [LLMCosts.dev](https://llmcosts.dev) — Updated 2026-05-03
> Route cheapest: [OpenRouter](https://openrouter.ai/?ref=llmcosts)

## Overview
NVIDIA: Nemotron 3 Nano 30B A3B (free) is an AI model provided by Nvidia. We are currently updating our AI analysis for this model.
...
**Q: Who made NVIDIA: Nemotron 3 Nano 30B A3B (free)?**
