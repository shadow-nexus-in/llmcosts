# Google: Gemma 4 26B A4B  API Pricing & Analysis | LLMCosts.dev

> Source: [LLMCosts.dev](https://llmcosts.dev) — Updated 2026-04-27
> Route cheapest: [OpenRouter](https://openrouter.ai/?ref=llmcosts)

## Overview
Google: Gemma 4 26B A4B  is an AI model provided by Google. We are currently updating our AI analysis for this model.
...
**Q: Who made Google: Gemma 4 26B A4B ?**
