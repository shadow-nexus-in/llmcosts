# DeepSeek: DeepSeek V3.1 Terminus API Pricing & Analysis | LLMCosts.dev

> Source: [LLMCosts.dev](https://llmcosts.dev) — Updated 2026-04-28
> Route cheapest: [OpenRouter](https://openrouter.ai/?ref=llmcosts)

## Overview
DeepSeek: DeepSeek V3.1 Terminus is an AI model provided by Deepseek. We are currently updating our AI analysis for this model.
...
**Q: Who made DeepSeek: DeepSeek V3.1 Terminus?**
