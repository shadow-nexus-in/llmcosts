# OpenAI: GPT-5.2 (batch) API Pricing & Analysis | LLMCosts.dev

> Source: [LLMCosts.dev](https://llmcosts.dev) — Updated 2026-07-30
> Route cheapest: [OpenRouter](https://openrouter.ai/?ref=llmcosts)

## Overview
OpenAI: GPT-5.2 (batch) is an AI model provided by Openai. We are currently updating our AI analysis for this model.
...
**Q: Who made OpenAI: GPT-5.2 (batch)?**
