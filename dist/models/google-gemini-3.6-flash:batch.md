# Google: Gemini 3.6 Flash (batch) API Pricing & Analysis | LLMCosts.dev

> Source: [LLMCosts.dev](https://llmcosts.dev) — Updated 2026-08-09
> Route cheapest: [OpenRouter](https://openrouter.ai/?ref=llmcosts)

## Overview
Google: Gemini 3.6 Flash (batch) is an AI model provided by Google. We are currently updating our AI analysis for this model.
...
**Q: Who made Google: Gemini 3.6 Flash (batch)?**
