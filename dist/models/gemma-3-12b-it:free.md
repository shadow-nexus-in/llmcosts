# Google: Gemma 3 12B (free) API Pricing & Analysis | LLMCosts.dev

> Source: [LLMCosts.dev](https://llmcosts.dev) — Updated 2026-04-25
> Route cheapest: [OpenRouter](https://openrouter.ai/?ref=llmcosts)

## Overview
Google: Gemma 3 12B (free) is an AI model provided by Google. We are currently updating our AI analysis for this model.
...
**Q: Who made Google: Gemma 3 12B (free)?**
