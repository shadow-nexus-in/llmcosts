# Arcee AI: Trinity Large Preview (free) API Pricing & Analysis | LLMCosts.dev

> Source: [LLMCosts.dev](https://llmcosts.dev) — Updated 2026-04-25
> Route cheapest: [OpenRouter](https://openrouter.ai/?ref=llmcosts)

## Overview
Arcee AI: Trinity Large Preview (free) is an AI model provided by Arcee-ai. We are currently updating our AI analysis for this model.
...
**Q: Who made Arcee AI: Trinity Large Preview (free)?**
A: It is provided by Arcee-ai.
