# OpenAI: GPT-5.4 Nano (batch) API Pricing & Analysis | LLMCosts.dev

> Source: [LLMCosts.dev](https://llmcosts.dev) — Updated 2026-08-15
> Route cheapest: [OpenRouter](https://openrouter.ai/?ref=llmcosts)

## Overview
OpenAI: GPT-5.4 Nano (batch) is an AI model provided by Openai. We are currently updating our AI analysis for this model.
...
**Q: Who made OpenAI: GPT-5.4 Nano (batch)?**
