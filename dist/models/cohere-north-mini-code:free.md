# Cohere: North Mini Code (free) API Pricing & Analysis | LLMCosts.dev

> Source: [LLMCosts.dev](https://llmcosts.dev) — Updated 2026-07-17
> Route cheapest: [OpenRouter](https://openrouter.ai/?ref=llmcosts)

## Overview
Cohere: North Mini Code (free) is an AI model provided by Cohere. We are currently updating our AI analysis for this model.
...
**Q: Who made Cohere: North Mini Code (free)?**
A: It is provided by Cohere.
