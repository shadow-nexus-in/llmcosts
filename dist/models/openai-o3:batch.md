# OpenAI: o3 (batch) API Pricing & Analysis | LLMCosts.dev

> Source: [LLMCosts.dev](https://llmcosts.dev) — Updated 2026-08-13
> Route cheapest: [OpenRouter](https://openrouter.ai/?ref=llmcosts)

## Overview
OpenAI: o3 (batch) is an AI model provided by Openai. We are currently updating our AI analysis for this model.
