# NVIDIA: Nemotron Nano 12B 2 VL (free) API Pricing & Analysis | LLMCosts.dev

> Source: [LLMCosts.dev](https://llmcosts.dev) — Updated 2026-04-16
> Route cheapest: [OpenRouter](https://openrouter.ai/?ref=llmcosts)

## Overview
NVIDIA: Nemotron Nano 12B 2 VL (free) is an AI model provided by Nvidia. We are currently updating our AI analysis for this model.
...
**Q: Who made NVIDIA: Nemotron Nano 12B 2 VL (free)?**
