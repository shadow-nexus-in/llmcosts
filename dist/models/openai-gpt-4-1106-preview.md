# OpenAI: GPT-4 Turbo (older v1106) API Pricing & Analysis | LLMCosts.dev

> Source: [LLMCosts.dev](https://llmcosts.dev) — Updated 2026-04-18
> Route cheapest: [OpenRouter](https://openrouter.ai/?ref=llmcosts)

## Overview
OpenAI: GPT-4 Turbo (older v1106) is an AI model provided by Openai. We are currently updating our AI analysis for this model.
...
**Q: Who made OpenAI: GPT-4 Turbo (older v1106)?**
