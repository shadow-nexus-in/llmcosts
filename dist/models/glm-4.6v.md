# Z.ai: GLM 4.6V API Pricing & Analysis | LLMCosts.dev

> Source: [LLMCosts.dev](https://llmcosts.dev) — Updated 2026-04-27
> Route cheapest: [OpenRouter](https://openrouter.ai/?ref=llmcosts)

## Overview
Z.ai: GLM 4.6V is an AI model provided by Z-ai. We are currently updating our AI analysis for this model.
