# MiniMax: MiniMax M2.5 (free) API Pricing & Analysis | LLMCosts.dev

> Source: [LLMCosts.dev](https://llmcosts.dev) — Updated 2026-04-26
> Route cheapest: [OpenRouter](https://openrouter.ai/?ref=llmcosts)

## Overview
MiniMax: MiniMax M2.5 (free) is an AI model provided by Minimax. We are currently updating our AI analysis for this model.
...
**Q: Who made MiniMax: MiniMax M2.5 (free)?**
A: It is provided by Minimax.
