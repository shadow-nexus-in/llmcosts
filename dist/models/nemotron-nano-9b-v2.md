# NVIDIA: Nemotron Nano 9B V2 API Pricing & Analysis | LLMCosts.dev

> Source: [LLMCosts.dev](https://llmcosts.dev) — Updated 2026-04-22
> Route cheapest: [OpenRouter](https://openrouter.ai/?ref=llmcosts)

## Overview
NVIDIA: Nemotron Nano 9B V2 is an AI model provided by Nvidia. We are currently updating our AI analysis for this model.
...
**Q: Who made NVIDIA: Nemotron Nano 9B V2?**
