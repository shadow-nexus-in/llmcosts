# NVIDIA: Nemotron Nano 9B V2 (free) API Pricing & Analysis | LLMCosts.dev

> Source: [LLMCosts.dev](https://llmcosts.dev) — Updated 2026-04-18
> Route cheapest: [OpenRouter](https://openrouter.ai/?ref=llmcosts)

## Overview
NVIDIA: Nemotron Nano 9B V2 (free) is an AI model provided by Nvidia. We are currently updating our AI analysis for this model.
...
**Q: Who made NVIDIA: Nemotron Nano 9B V2 (free)?**
