# Claude Opus 5 (batch) API Pricing & Analysis | LLMCosts.dev

> Source: [LLMCosts.dev](https://llmcosts.dev) — Updated 2026-08-16
> Route cheapest: [OpenRouter](https://openrouter.ai/?ref=llmcosts)

## Overview
Claude Opus 5 (batch) is an AI model provided by Anthropic. We are currently updating our AI analysis for this model.
...
**Q: Who made Claude Opus 5 (batch)?**
