# Venice: Uncensored (free) API Pricing & Analysis | LLMCosts.dev

> Source: [LLMCosts.dev](https://llmcosts.dev) — Updated 2026-04-16
> Route cheapest: [OpenRouter](https://openrouter.ai/?ref=llmcosts)

## Overview
Venice: Uncensored (free) is an AI model provided by Cognitivecomputations. We are currently updating our AI analysis for this model.
...
**Q: Who made Venice: Uncensored (free)?**
A: It is provided by Cognitivecomputations.
