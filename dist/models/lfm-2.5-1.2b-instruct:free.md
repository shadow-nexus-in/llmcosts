# LiquidAI: LFM2.5-1.2B-Instruct (free) API Pricing & Analysis | LLMCosts.dev

> Source: [LLMCosts.dev](https://llmcosts.dev) — Updated 2026-04-21
> Route cheapest: [OpenRouter](https://openrouter.ai/?ref=llmcosts)

## Overview
LiquidAI: LFM2.5-1.2B-Instruct (free) is an AI model provided by Liquid. We are currently updating our AI analysis for this model.
...
**Q: Who made LiquidAI: LFM2.5-1.2B-Instruct (free)?**
