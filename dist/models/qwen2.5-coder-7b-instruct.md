# Qwen: Qwen2.5 Coder 7B Instruct API Pricing & Analysis | LLMCosts.dev

> Source: [LLMCosts.dev](https://llmcosts.dev) — Updated 2026-04-15
> Route cheapest: [OpenRouter](https://openrouter.ai/?ref=llmcosts)

## Overview
Qwen: Qwen2.5 Coder 7B Instruct is an AI model provided by Qwen. We are currently updating our AI analysis for this model.
...
**Q: Who made Qwen: Qwen2.5 Coder 7B Instruct?**
