# OpenAI: GPT-3.5 Turbo (batch) API Pricing & Analysis | LLMCosts.dev

> Source: [LLMCosts.dev](https://llmcosts.dev) — Updated 2026-08-11
> Route cheapest: [OpenRouter](https://openrouter.ai/?ref=llmcosts)

## Overview
OpenAI: GPT-3.5 Turbo (batch) is an AI model provided by Openai. We are currently updating our AI analysis for this model.
...
**Q: Who made OpenAI: GPT-3.5 Turbo (batch)?**
