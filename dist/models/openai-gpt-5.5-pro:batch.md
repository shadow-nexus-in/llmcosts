# OpenAI: GPT-5.5 Pro (batch) API Pricing & Analysis | LLMCosts.dev

> Source: [LLMCosts.dev](https://llmcosts.dev) — Updated 2026-08-10
> Route cheapest: [OpenRouter](https://openrouter.ai/?ref=llmcosts)

## Overview
OpenAI: GPT-5.5 Pro (batch) is an AI model provided by Openai. We are currently updating our AI analysis for this model.
...
**Q: Who made OpenAI: GPT-5.5 Pro (batch)?**
